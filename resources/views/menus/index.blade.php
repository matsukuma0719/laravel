    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
        @foreach ($menus as $menu)
            <a href="{{ route('menus.show', $menu->id) }}"
               class="block bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-500 rounded-lg shadow overflow-hidden hover:shadow-lg hover:border-blue-400 transition cursor-pointer">
                {{-- 上半分：画像エリア --}}
                ...
                <div class="p-3 text-center">
                    ...
                    <div class="text-gray-600 dark:text-gray-200 text-sm">料金：{{ number_format($menu->price) }}円</div>
